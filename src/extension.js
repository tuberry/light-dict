...
import { ROOT_DIR, fopen, noop, omap, xnor, lot, execute, nonEq, cancelled, homolog, capitalize, pickle } from './util.js';
...
class DictAct extends Destroyable {
    ...
    execute(cmd) {
        return execute(cmd, this._tty, this._src.cancel.refreshSource());
    }
}
...
class LightDict extends Destroyable {
    ...
    _buildWidgets(gset) {
        ...
        this._src = manageSource(this, () => omit(this, 'dbus', 'systray', 'waiting', '_bar', '_box', '_act', '_cur'), {
